...
const Login = () => {
  ...
  const googleLogoColor = '#eb4034';
    ...
    return ( <View className="mt-8 ml-2 mr-2">
        ...
        <Text className="text-3xl font-bold mt-5 mb-20" >Login</Text>
    ...
    <View className="m-1 ml-1 mr-1 relative bg-white rounded">
      ...
      <TextInput
      className="border p-4 pt-5 rounded "
...
<View className="">
  <Text className="text-right text-base">Forget your Password? <AntDesign name="arrowright" size={20} color="red" /> </Text>
</View>
...
<TouchableOpacity
      ...
      >
        <Text className="text-center font-bold text-white text-base" >Login</Text>
        </TouchableOpacity>
        <View className="mt-60 items-center">
          <Text className="text-base">Or login with social account</Text>
