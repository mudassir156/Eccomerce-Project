...
import { Text, View, TextInput, Image, TouchableOpacity, KeyboardAvoidingView, ScrollView, FlatList } from "react-native";
import { EvilIcons, Entypo, FontAwesome5, Fontisto } from '@expo/vector-icons';
            ...
            <ScrollView>
              <View style={{margin:7}}>
                <Animated.View entering={FadeInDown.delay(300)} style={{ marginTop: 20, marginLeft: 4, flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <Text style={{ marginRight: 100, fontSize: 20, marginLeft: 100, color: 'slategray' }}>Location</Text>
